		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#verticalproject123-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"verticalproject123-display": {
								"semanticObject": "verticalproject123",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vertical.project123",
									"url": sap.ui.require.toUrl("vertical/project123")
								}
							}
						}
					}
